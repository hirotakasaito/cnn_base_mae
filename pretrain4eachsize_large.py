...
from util.dataset import EachSizeDataset
...
def arg_parse():
    ...
    parser.add_argument('--dataset-dir', type=str, default='/root/dataset/Images/d_kan1_10pt')
    # parser.add_argument('--pretrained-dir', type=str, default="/root/logs/pretrain/20220714T124257.974967")
...
if __name__ == "__main__":
    ...
    dataset = EachSizeDataset(dataset_dir = dataset_dir)
